...
uint32_t Gamepad07382217C::getState() {
	 uint32_t state = 0;
...
void Gamepad07382217C::update(uint8_t dev_addr, uint8_t instance, uint8_t const *report, uint16_t len) {
	if (len != 3) {
		return;
	}
